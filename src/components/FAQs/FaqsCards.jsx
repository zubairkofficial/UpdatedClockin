...
function FaqsCards() {
    return (
        <div className='bg-[#222626] py-12'>
            {/* first row */}
            <div className='flex items-stretch justify-center gap-x-9 p-8'>
                <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-lg bg-[#2C3131] flex flex-col">
                    <div className="w-20 h-20 bg-[#464B4B] rounded-full ml-6 mt-6 flex-shrink-0">
                        <img className='px-4 py-4' src="assets/activity-tracker.png" />
                    </div>
                    <div className="px-6 py-4 flex-grow">
                        <div className="font-bold text-xl mb-4 text-white mt-4">What is Time Tracker Software?</div>
                ...
                <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-lg bg-[#2C3131] flex flex-col">
                    ...
                    <div className="px-6 py-4 flex-grow">
                        <div className="font-bold text-xl mb-4 text-white mt-4">Why should I use clockin?</div>
                        <p className="text-gray-300 mb-3">
                ...
                <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-lg bg-[#2C3131] flex flex-col">
                    ...
                    <div className="px-6 py-4 flex-grow">
                        <div className="font-bold text-xl mb-4 text-white mt-4">How does clockin Work?</div>
                        <p className="text-gray-300 mb-3">
                ...
                <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-lg bg-[#2C3131] flex flex-col">
                    ...
                    <div className="px-6 py-4 flex-grow">
                        <div className="font-bold text-xl mb-4 text-white mt-4">Is clockin Software suitable for individuals and teams?</div>
                        <p className="text-gray-300 mb-3">
