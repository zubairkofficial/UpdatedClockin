...
function FaqsCards() {
    ...
    className="mySwiper"
    style={{ position: 'relative', marginLeft: '5%', padding: '1%' }}
>
    ...
    style={{ position: 'relative', marginLeft: '5%', padding: '1%' }}
>
    <div className='lg:flex items-stretch justify-center gap-x-9 p-8 sm:block ml-12 bg-black'>
        <SwiperSlide className="flex">
            <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-xl bg-faqbg flex flex-col min-h-full">
                <div className="w-20 h-20 bg-imagebgcolor rounded-full ml-6 mt-6 flex-shrink-0">
                    <img className='px-4 py-4' src="assets/activity-tracker.png" />
        ...
        <SwiperSlide className="flex">
            ...
            {/* third row */}
            {/* <div className='lg:flex items-stretch justify-center gap-x-9 p-8 sm:block'>
                <div className="max-w-xs w-full rounded-3xl overflow-hidden shadow-xl bg-pinkbackground flex flex-col">
                    <div className="w-20 h-20 bg-imagebgcolor rounded-full ml-6 mt-6 flex-shrink-0">
                        <img className='px-4 py-4' src="assets/activity-tracker.png" />
                    </div>
                    <div className="px-6 py-4 flex-grow">
