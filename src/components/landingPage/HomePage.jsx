...
const HomePage = ({ background, heading, subheading }) => {
  ...
  return (
//     <>
//     <div className="bg-cover bg-center bg-no-repeat h-screen w-full " style={{ backgroundImage: `url(${isLightMode ? 'assets/bg1.png' : 'assets/bg2.png'})` }}>
//       <Header logo="assets/logo.png" />
//       <div className="container mx-auto px-4 pt-7 ">
//         <div className="flex flex-col lg:flex-row items-center lg:items-start">
//           <div className="lg:w-1/2 w-full lg:order-2 order-1 mt-8 lg:mt-0">
//             <img
...
<>
  ...
  >
    ...
    {/* <img
      src="assets/topcorner.png"
      alt="Top Left Decoration"
      className="absolute top-0 left-0 w-32 h-32" // Adjust the size as needed
    /> */}
    ...
    {/* <img
      ...
      className="absolute bottom-0 right-0 w-32 h-32" // Adjust the size as needed
    /> */}
  </div>
</>
