    ...
    const features1 = [
        {
            ...
            description: "Efficiently organize and track employees' activities with our seamless employees management feature. Streamline productivity today!",
        },
        {
            href: 'employeesManagement',
            imgSrc: 'assets/f2.png',
            title: 'Time Tracker',
            description: "Track time effortlessly. Optimize projects, enhance productivity with our user-friendly Time Tracker feature. Try it now!",
        },
        {
            href: 'employeesManagement',
            imgSrc: 'assets/f3.png',
            title: 'Task Management',
            description: "Simplify tasks. Achieve goals. Utilize our Task Management tool for seamless project coordination. Elevate productivity instantly!",
        },
    ...
    const features2 = [
        {
            ...
            title: 'Notes',
            description: "Capture insights swiftly. Integrate Notes feature for contextual details. Elevate project tracking and collaboration effortlessly. Try it now!",
        },
        {
            href: 'employeesManagement',
            imgSrc: 'assets/f5.png',
            title: '24/7 Support',
            description: "Get assistance anytime. Our 24/7 Support ensures seamless software experience. Stay productive with uninterrupted help. Connect with us!",
        },
        {
            href: 'employeesManagement',
            imgSrc: 'assets/f6.png',
            title: 'Multi Packages',
            description: "Choose flexibility. Opt for our Multi Packages feature. Tailor time tracking to you needs. Efficient and customizable. Try now!",
        },
