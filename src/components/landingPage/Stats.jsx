...
const Stats = () => {
    ...
    return (
        ...
        <>
            {stat.map(stat => (
                <div className="lg:flex block justify-around bg-lightpink py-16 container mx-auto rounded-xl w-full " key={stat.id}>
                            ...
                            <div className="mb-4 flex justify-center items-center">
                                <div className="relative">
                                    ...
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                                        <h1 className="text-3xl lg:text-7xl font-bold text-text">{stat.total_task}</h1>
                                        <h3 className="text-text lg:text-3xl text-xl">Total Task</h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="sm:pl-5 sm:pr-15 lg:pl-16 md:pl-12 lg:pr-14 md:pr-10 mt-16 lg:mr-16 md:mr-12 sm:mr-5 p-[5%] w-[100%] lg:w-[40%]">
                        ...
                        {JSON.parse(stat.content).map((item,index ) => (
                            ...
                            <div className="mt-4" key={index}>
                                <p className="text-[#FF7A50] font-semibold">{index+1}. {item.subheading}</p>
