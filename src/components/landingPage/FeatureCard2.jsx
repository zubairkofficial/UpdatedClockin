        ...
        <div>
            <div className='px-5 md:px-12 lg:px-16 xl:px-20 py-2'>
                <a href='employeesManagement' className='block text-center md:text-left'>
                    <img className='bg-[#FF7A50] hover:bg-orange-700 px-3 py-2 rounded-lg mx-auto transition duration-300 md:mx-0' src="assets/f2.png" alt='management' />
                    <h2 className='font-bold text-text py-4'>Time Tracker</h2>
