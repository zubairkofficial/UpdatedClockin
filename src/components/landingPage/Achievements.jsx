  ...
  return (
    <div className="bg-pinkbackground pb-12 pt-3  container mx-auto px-0">
      <div className=''>
        ...
        <p className='text-center text-gray-400 pt-6 text-lg p-5 w-1/2'>{currentContent['achievement-2'] || 'Optimized productivity, streamlined tasks and improved efficiency with our innovative time tracker software.'}</p>
        </div>
      </div>
