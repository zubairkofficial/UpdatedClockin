...
const DraggableTextArea = ({ type }) => {
    ...
    return (
        ...
        <i class="fa-regular fa-line-columns pt-3" style={{ fontSize: '1.5rem' }}></i><br/>
            ...
            <button className='btn' style={{ opacity: isDragging ? 0.5 : 1 }}>TextArea</button>
        </div>
    );
};
