...
function NewPageScreen({ heading, click, container, handleContainer, headingStyle, colorStyle, padding, margin, align, imagesize, imageradius , setSelectedElement , selectedElement}) {
    ...
    //             type: '',
    //             content: '',
    //             style: { padding: {}, margin: {}, headingStyle: 'none' , color : 'white', size: { width: '100%', height: 'auto' } }
    //         })),
    //     };
    ...
    return (
        ...
        setSelectedElement={setSelectedElement}
                ...
                <div className={`flex justify-around mt-8 pl-20 py-5 rounded-md relative ${sections ? 'hidden' : ''}`} style={{ border: 'dashed', borderWidth: '1px', borderColor: 'white' }}>
                    <>
                        <label
